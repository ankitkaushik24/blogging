export const metadata = {
  ...
  author: "parrellad",
  image:
    "/blogging/assets/images/posts/2025/error_monitoring_main_image_front_page.webp",
  featured: true,
  description:
...
](/blogging/assets//images/posts/2025/pkce-flow.webp "PKCE Flow")

![sentry-issue-created-from-logback-integration .webp](/blogging/assets//images/posts/2025/sentry-issue-created-from-logback-integration.webp "Sample Sentry Issue created from logback integration")
...
![error-monitoring-issue-alert.webp](/blogging/assets//images/posts/2025/error-monitoring-issue-alert.webp "An issue alert in Sentry")
...
![error-monitoring-metric-alert.webp](/blogging/assets//images/posts/2025/error-monitoring-metric-alert.webp "A metric alert in Sentry")
